        ...
        return function() {
                ...
                n = function() {
                    ...
                    return e(d, [{
                        ...
                        value: function() {
                            ...
                            this.d.allowDropdown && (a += " allow-dropdown"), this.d.separateDialCode && (a += " separate-dial-code");
                            var b = this._e2("div", {
                                "class": a
                            });
                        ...
                        value: function() {
                            var a = this;
                            this._a5 = function(c) {
                                a.a === b.activeElement || a.a.value || (c.preventDefault(), a.a.focus())
                        ...
                        value: function() {
                            ...
                            return (this.d.separateDialCode ? "+".concat(b) : a && "+" !== a.charAt(0) && "1" !== a.charAt(0) && b && "1" === b.charAt(0) && 4 === b.length && b !== d.substr(0, 4) ? b.substr(1) : "") + a
                        }
                    }, {
                        key: "_7",
                        value: function(a) {
                        ...
                        value: function() {
                            ...
                            this.hiddenInput && b && b.removeEventListener("submit", this._a14), this.d.autoHideDialCode && (this.a.removeEventListener("mousedown", this._a5), this.a.removeEventListener("focus", this._a7), b && b.removeEventListener("submit", this._a8), this.a.removeEventListener("blur", this._a8)), this.a.removeEventListener("keyup", this._a12), this.a.removeEventListener("cut", this._a13), this.a.removeEventListener("paste", this._a13);
            ...
            return a.intlTelInputGlobals.loadUtils = function(b) {
                    if (!a.intlTelInputUtils && !a.intlTelInputGlobals.startedLoadingUtilsScript) {
                        if (a.intlTelInputGlobals.startedLoadingUtilsScript = !0,
                            "undefined" != typeof Promise) return new Promise(function(a, c) {
                            return o(b, a, c)
                        });
                        o(b)
                    }
                    return null
                }, a.intlTelInputGlobals.defaults = j, a.intlTelInputGlobals.version = "14.0.6",
                function(b, c) {
                    var d = new n(b, c);
                    return d._init(), a.intlTelInputGlobals.instances[d.id] = d, d
                }
        }()
    }(window, document);
